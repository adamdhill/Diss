...
# Who does what, and why does it matter? Mechanism Design 

Traditional EA is one of the most successful instances of what came to be called "mechanism design." [@Maskin2008] Mechanism design "can be thought of as the 'engineering' side of economic theory." [@Maskin2008, p. 567] Mechanism design begins by identifying a desired outcome and then seeks to create institutions that achieve that goal. ^["Mechanism design is narrower than "institutional design." The latter seeks all-in evaluations of institutions, a project that incorporates not only predictions about outcomes but also value considerations.] 

Issues of mechanism design are interesting because, typically, we do not know, ex ante, what the optimal outcome is. The mechanisms must generate the information. Ordinarily, the market is the best mechanism.  
