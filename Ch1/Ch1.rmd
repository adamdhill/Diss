...
In order to know how to evaluate these empirical claims, and their normative consequences, we should consider the kind of theory that is on offer.

# What *is* a Theory of Electoral Accountability? A Brief Overview of Mechanism Design 

Traditional EA is one of the most successful instances of an approach to social that came to be called "mechanism design." [@Maskin2008] Broadly, mechanism design "can be thought of as the 'engineering' side of economic theory." [@Maskin2008, p. 567] Where game theory "takes the rules of the game as given, and [] makes predictions about the behavior of strategic players," mechanism design "is about the optimal choice of the rules of the game." [@Borgers2015, p. 2] This decision is made by identifying a desired outcome and then seeking to create institutions that achieve that goal. ^["Mechanism design is narrower than "institutional design." The latter seeks all-in evaluations of institutions, a project that incorporates not only predictions about outcomes but also value considerations.] Alternatively, mechanism design my proceed by identifying real-world institutions and interpreting those institutions as a product of rational choices by their designers. [@Borgers2015] 
...
There is always a gap between a real-world practice and the model produced by mechanism design. One way to think of this gap is as an unavoidable cost that is paid in order to achieve generality. On this view, one should always be cognizant that one is use a model that abstracts away features of the world in order to explain others. There is another, more positive way to look at the gap between real-world practice and models, however. Elegant, highly generalized models make only a few assumptions about real-world "preferences, technologies, and so on." [@Maskin2008, p. 572] The generality of these models then allows for wide lattitude in implementation. For example, in the case of elections, a mechanism that does not depend on a specific voting rule is better than one requires majority rule (which is preferable in cases of only two candidates). [@Maskin2002, p. 240] Elegance is a particularly value feature of mechanism design in many contexts. For example, in the area of development policy, elegant mechanisms are of particular use, because they tend to allow for a wide range of cultural and social forces. By contrast, narrow mechanisms tend to fail when applied beyond their original habitat. Perhaps the best example of this is American style property rights, which are often thought to be central to economic development yet also deeply contingent on certain cultural practices.  

There is a difference, however, between elegance and  
