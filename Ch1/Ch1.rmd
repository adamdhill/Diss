...
The existence of an agency relationship, in turn, authorizes otherwise ordinary individuals to govern through coercive measures. 

# What is ultra vires for us?  

On the traditional account, if we observe governance institutions whose (economic) policy is *not* the product of basic preferences, we can conclude    
