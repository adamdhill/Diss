...
Traditional EA is one of the most successful instances of an approach to social science called "mechanism design." [@Maskin2008] Broadly, mechanism design "can be thought of as the 'engineering' side of economic theory." [@Maskin2008, p. 567] It is useful to compare mechanism design to the more well-known field of game theory. Where game theory "takes the rules of the game as given, and [] makes predictions about the behavior of strategic players," mechanism design "is about the optimal choice of the rules of the game." [@Borgers2015, p. 2] Mechanism design seeks to determine what rules are optimal, given a set of goals to be achieved. Game theory seeks to explain how rational individuals would respond to that environment. Both mechanism design and game theory, therefore, rely on identifying equilibriums -- that is, joint strategic solutions where no one involved has an incentive to deviate from the strategy that they are playing.[@Maskin2008, p. 571, fn. 4]   
